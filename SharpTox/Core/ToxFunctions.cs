...
#region Group Functions
        ...
        [DllImport(dll, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_group_set_name")]
        public static extern int GroupSetName(ToxHandle tox, int groupnumber, byte[] name, ushort length);
